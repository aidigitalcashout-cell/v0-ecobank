      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <div>
          ...
          <div className="bg-gray-100 rounded-lg p-4">
            <div className="font-medium text-sm mb-1">Pedro Banabas</div>
            <div className="text-xs text-gray-600 mb-2">0348483930</div>
            <div className="text-xs text-gray-500">Firstbank</div>
          </div>
        </div>
